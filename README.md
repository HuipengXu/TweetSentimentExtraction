...
* 使用 StratifiedKFold 的其中一折作为验证集，实验一次，但模型结果在 70-71 之间，第二次换种子，最高分 71.01，第三次换种子，最高分 71.34，第四次种子，最高分 71.56，第五次种子，最高分 70.96，第六次种子，最高分71.59；使用 df 的 sample 然后直接取前 5000 个样本作为验证集，第一次实验但模型在 70-71 之间，第二次换种子实验，模型又达到了 71-72 之间。



* 2020.09.21——

  |         1st-model         | jacquard-based soft labels | MSD  | hidden-state | dropout | fc-normal-init | epoch |  lr  |  bs  | max-seq-len | fp16/o1 | weight-decay | best-steps/total-steps | n-gpus | warmup-steps | jaccard (best/final) | 备注 |
  | :-----------------------: | :------------------------: | :--: | :----------: | :-----: | :------------: | :---: | :--: | :--: | :---------: | :-----: | :----------: | :--------------------: | :----: | :----------: | :------------------: | ---- |
  |       roberta-base        |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |        400/430         |   4    |      0       |   71.5899/71.5320    |      |
  |       roberta-base        |             1              |  1   | last3h+conv  |    0    |       0        |   6   | 5e-5 |  64  |     128     |    0    |      0       |        600/690         |   3    |      0       |   71.5216/71.3766    |      |
  |      roberta-base-cv      |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |           -            |   4    |      0       |       71.0710        |      |
  |                           |                            |      |              |         |                |       |      |      |             |         |              |                        |        |              |                      |      |
  |    roberta-base-squad2    |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |         */430          |   4    |      0       |      71.6751/*       |      |
  |    roberta-base-squad2    |             1              |  1   | last3h+conv  |    0    |       0        |   6   | 5e-5 |  64  |     128     |    0    |      0       |        650/690         |   3    |      0       |   71.2193/71.1961    |      |
  |  roberta-base-squad2-cv   |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |           -            |   4    |      0       |       70.8490        |      |
  |                           |                            |      |              |         |                |       |      |      |             |         |              |                        |        |              |                      |      |
  |    distilroberta-base     |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |         */430          |   4    |      0       |      71.0203/*       |      |
  |    distilroberta-base     |             1              |  1   | last3h+conv  |    0    |       0        |   3   | 5e-5 |  64  |     128     |    0    |      0       |         */345          |   4    |      0       |       71.06/*        |      |
  |                           |                            |      |              |         |                |       |      |      |             |         |              |                        |        |              |                      |      |
  | distilroberta-base-squad2 |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  64  |     128     |    0    |      0       |        400/430         |   4    |      0       |   71.0914/70.9602    |      |
  | distilroberta-base-squad2 |             1              |  1   | last3h+conv  |    0    |       0        |   3   | 5e-5 |  64  |     128     |    0    |      0       |         */345          |   4    |      0       |      70.8168/*       |      |
  |                           |                            |      |              |         |                |       |      |      |             |         |              |                        |        |              |                      |      |
  |       roberta-large       |             1              |  1   | last3h+conv  |    0    |       0        |   5   | 5e-5 |  16  |     128     |    0    |      0       |       1500/1720        |   4    |      0       |   70.2273/70.1023    |      |
  |       roberta-large       |             1              |  1   | last3h+conv  |    0    |       0        |   2   | 7e-5 |  16  |     128     |    0    |      0       |         */688          |   4    |      0       |      70.5999/*       |      |

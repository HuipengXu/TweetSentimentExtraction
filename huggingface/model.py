...
class RobertaForQuestionAnswering(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.conv = nn.Conv1d(config.hidden_size * 2, config.hidden_size, kernel_size=3, padding=(3 - 1) // 2)
    ...
    def forward(self, input_ids, attention_mask, start_positions=None, end_positions=None, use_jaccard_soft=False):
        ...
        out = torch.cat([hidden_states[-1], hidden_states[-1]], dim=-1).permute(0, 2, 1)
